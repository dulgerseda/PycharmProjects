...
class OfficeBuilding(Building):
    ...
    def __init__(self, nr_of_floors, nr_of_working_places):
        ...
        self._number_of_working_places = nr_of_working_places

    def get_number_of_working_places(self):
        return self._number_of_working_places


# TASK 4 — create objects and print info
b1 = Building(5)
o1 = OfficeBuilding(10, 120)

print("Building ID:", b1._building_id,
      "Floors:", b1.get_number_of_floors())

print("OfficeBuilding ID:", o1._building_id,
      "Floors:", o1.get_number_of_floors(),
      "Working Places:", o1.get_number_of_working_places())
